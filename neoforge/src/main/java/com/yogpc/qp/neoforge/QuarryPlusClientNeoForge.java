...
public final class QuarryPlusClientNeoForge {
    ...
    public static void clientInit(FMLClientSetupEvent event) {
        QuarryPlus.LOGGER.info("Initialize Client({})", event.getClass().getSimpleName());
    ...
    public static void registerMenu(RegisterMenuScreensEvent event) {
        ...
        event.register(PlatformAccessNeoForge.RegisterObjectsNeoForge.ADV_PUMP_MENU_TYPE.get(), AdvPumpScreen::new);
