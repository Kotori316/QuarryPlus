...
public final class QuarryPlusFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.putBlock(PlatformAccessFabric.RegisterObjectsFabric.FRAME_BLOCK, ChunkSectionLayer.CUTOUT);
        BlockRenderLayerMap.putBlock(PlatformAccessFabric.RegisterObjectsFabric.SOFT_BLOCK, ChunkSectionLayer.TRANSLUCENT);
        ...
        MenuScreens.register(PlatformAccessFabric.RegisterObjectsFabric.ADV_PUMP_MENU, AdvPumpScreen::new);
