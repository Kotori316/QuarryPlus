...
public class Recipe extends QuarryPlusDataProvider.QuarryDataProvider {
    ...
    private List<RecipeSerializeHelper> workbenchRecipes() {
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.GEMS_DIAMOND), 32)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_GOLD), 32)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_IRON), 64)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 16)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.ENDER_PEARLS), 4))
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_IRON), 48)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 64)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.GLASS_COLORLESS), 512)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Items.CACTUS), 80))
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_GOLD), 7)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_IRON), 8)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 12)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_GLOWSTONE), 4)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Items.LAPIS_LAZULI), 12))
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_GOLD), 3)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_IRON), 16)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 8))
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_GOLD), 16)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_IRON), 24)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 32)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.OBSIDIAN), 4)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Items.LAPIS_LAZULI), 8))
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_GOLD), 32)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.GEMS_QUARTZ), 64)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Items.REPEATER), 16)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Items.COMPARATOR), 8))
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.GEMS_DIAMOND), 32)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_GOLD), 8)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_IRON), 8)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 48)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.OBSIDIAN), 64)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Items.ANVIL), 2)),
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.OBSIDIAN), 32)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.STORAGE_BLOCKS_DIAMOND), 16)),
        ...
        list.add(RecipeSerializeHelper.by(new FinishedWorkbenchRecipe(new IngredientRecipe(
            ...
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.INGOTS_GOLD), 16)),
            new IngredientList(new IngredientWithCount(Ingredient.of(Tags.Items.RODS_BLAZE), 5)),
