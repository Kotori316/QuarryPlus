    ...
    override def renderTileEntityFast(quarry: TileQuarry, distanceX: Double, distanceY: Double, distanceZ: Double,
        ...
        if ((quarry.G_getNow == TileQuarry.Mode.NOTNEEDBREAK || quarry.G_getNow == TileQuarry.Mode.MAKEFRAME) && quarry.yMax != Integer.MIN_VALUE) {
            ...
            for (i <- 0 until subtract.getY) {
                ...
                buffer.pos(minPos.getX - d1, minPos.getY + d1 + i, minPos.getZ - d1).color(255, 255, 255, 255).tex(H_minU, H_minV).lightmap(240, 0).endVertex()
                buffer.pos(minPos.getX + d1, minPos.getY + d1 + i, minPos.getZ - d1).color(255, 255, 255, 255).tex(H_maxU, H_minV).lightmap(240, 0).endVertex()
                ...
                buffer.pos(maxPos.getX - d1, minPos.getY + d1 + i, minPos.getZ - d1).color(255, 255, 255, 255).tex(H_minU, H_minV).lightmap(240, 0).endVertex()
                buffer.pos(maxPos.getX + d1, minPos.getY + d1 + i, minPos.getZ - d1).color(255, 255, 255, 255).tex(H_maxU, H_minV).lightmap(240, 0).endVertex()
                ...
                buffer.pos(minPos.getX - d1, minPos.getY + d1 + i, maxPos.getZ - d1).color(255, 255, 255, 255).tex(H_minU, H_minV).lightmap(240, 0).endVertex()
                buffer.pos(minPos.getX + d1, minPos.getY + d1 + i, maxPos.getZ - d1).color(255, 255, 255, 255).tex(H_maxU, H_minV).lightmap(240, 0).endVertex()
                ...
                buffer.pos(maxPos.getX - d1, minPos.getY + d1 + i, maxPos.getZ - d1).color(255, 255, 255, 255).tex(H_minU, H_minV).lightmap(240, 0).endVertex()
                buffer.pos(maxPos.getX + d1, minPos.getY + d1 + i, maxPos.getZ - d1).color(255, 255, 255, 255).tex(H_maxU, H_minV).lightmap(240, 0).endVertex()
            ...
            for (i <- 0 until subtract.getZ) {
                ...
                def tempY(y: Double): Unit = {
                    buffer.pos(minPos.getX - d1, y - d1, minPos.getZ + d1 + i).color(255, 255, 255, 255).tex(V_minU, V_minV).lightmap(240, 0).endVertex()
                    ...
                    buffer.pos(minPos.getX + d1, y - d1, minPos.getZ + d1 + i).color(255, 255, 255, 255).tex(V_minU, V_maxV).lightmap(240, 0).endVertex()

                    buffer.pos(maxPos.getX - d1, y - d1, minPos.getZ + d1 + i).color(255, 255, 255, 255).tex(V_minU, V_minV).lightmap(240, 0).endVertex()
                    ...
                    buffer.pos(maxPos.getX + d1, y - d1, minPos.getZ + d1 + i).color(255, 255, 255, 255).tex(V_minU, V_maxV).lightmap(240, 0).endVertex()
                ...
                def tempX(x: Double): Unit = {
                    buffer.pos(x - d1, minPos.getY + d1, minPos.getZ + d1 + i).color(255, 255, 255, 255).tex(V_minU, V_minV).lightmap(240, 0).endVertex()
                    ...
                    buffer.pos(x - d1, minPos.getY - d1, minPos.getZ + d1 + i).color(255, 255, 255, 255).tex(V_minU, V_maxV).lightmap(240, 0).endVertex()

                    buffer.pos(x - d1, maxPos.getY + d1, minPos.getZ + d1 + i).color(255, 255, 255, 255).tex(V_minU, V_minV).lightmap(240, 0).endVertex()
                    ...
                    buffer.pos(x - d1, maxPos.getY - d1, minPos.getZ + d1 + i).color(255, 255, 255, 255).tex(V_minU, V_maxV).lightmap(240, 0).endVertex()
