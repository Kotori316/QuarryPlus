...
public class GuiController extends GuiScreen {
    ...
    public GuiController(final int d, final int x, final int y, final int z, final List<String> l) {
        ...
        this.yc = y;
        this.zc = z;
        names = l.stream().sorted(Comparator.naturalOrder()).collect(Collectors.toList());
    }
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(-1, this.width / 2 - 125, this.height - 26, 250, 20, I18n.format(TranslationKeys.DONE)));
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        drawCenteredString(this.fontRendererObj, I18n.format(TranslationKeys.YOG_SPAWNER_SETTING), this.width / 2, 8, 0xFFFFFF);
    }
