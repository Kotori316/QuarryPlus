...
object WorkbenchRecipes {
    ...
    def registerRecipes(): Unit = {
        ...
        addRecipe(ItemDamage(blockChunkdestroyer), 3200000, new ItemStack(blockQuarry, 75), new ItemStack(blockPump, 50), new ItemStack(itemTool, 25 * 25, 1), new ItemStack(blockMarker, 75), new ItemStack(DIAMOND_BLOCK, 8 * 25), new ItemStack(EMERALD_BLOCK, 8 * 25), new ItemStack(ENDER_EYE, 64 * 25))
    }
}