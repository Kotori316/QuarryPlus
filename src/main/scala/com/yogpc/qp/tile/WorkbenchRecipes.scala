...
object WorkbenchRecipes {
    ...
    def registerRecipes(): Unit = {
        ...
        addRecipe(ItemDamage(blockMarker), 20000, Seq(i => new ItemStack(REDSTONE, i * 6), i => new ItemStack(DYE, i * 6, 4), i => new ItemStack(GOLD_INGOT, i * 7 / 2), i => new ItemStack(IRON_INGOT, i * 4), i => new ItemStack(GLOWSTONE_DUST, i * 2), i => new ItemStack(ENDER_PEARL, i * 2 / 5)))
        addRecipe(ItemDamage(blockQuarry), 320000, Seq(i => new ItemStack(DIAMOND, i * 16), i => new ItemStack(GOLD_INGOT, i * 16), i => new ItemStack(IRON_INGOT, i * 32), i => new ItemStack(REDSTONE, i * 8), i => new ItemStack(ENDER_PEARL, i * 2), i => new ItemStack(NETHER_STAR, i * 3 / 25)))
        addRecipe(ItemDamage(blockMover), 320000, Seq(i => new ItemStack(OBSIDIAN, i * 32), i => new ItemStack(DIAMOND, i * 16), i => new ItemStack(ANVIL, i * 1), i => new ItemStack(REDSTONE, i * 24), i => new ItemStack(GOLD_INGOT, i * 4), i => new ItemStack(IRON_INGOT, i * 4), i => new ItemStack(NETHER_STAR, i * 1 / 25), i => new ItemStack(ENDER_PEARL, i * 1)))
        addRecipe(ItemDamage(blockMiningWell), 160000, Seq(i => new ItemStack(IRON_INGOT, i * 16), i => new ItemStack(REDSTONE, i * 8), i => new ItemStack(DIAMOND, i * 1), i => new ItemStack(ENDER_PEARL, i * 1), i => new ItemStack(NETHER_STAR, i * 1 / 25), i => new ItemStack(GOLD_INGOT, i * 3)))
        addRecipe(ItemDamage(blockPump), 320000, Seq(i => new ItemStack(IRON_INGOT, i * 24), i => new ItemStack(REDSTONE, i * 32), i => new ItemStack(GLASS, i * 256), i => new ItemStack(CACTUS, i * 40), i => new ItemStack(GOLD_INGOT, i * 8), i => new ItemStack(NETHER_STAR, i * 1 / 25), i => new ItemStack(ENDER_PEARL, i * 2 / 5)))
        addRecipe(ItemDamage(blockRefinery), 640000, Seq(i => new ItemStack(DIAMOND, i * 18), i => new ItemStack(GOLD_INGOT, i * 12), i => new ItemStack(IRON_INGOT, i * 12), i => new ItemStack(GLASS, i * 64), i => new ItemStack(REDSTONE, i * 16), i => new ItemStack(ANVIL, i * 1), i => new ItemStack(OBSIDIAN, i * 12), i => new ItemStack(NETHER_STAR, i * 1 / 25), i => new ItemStack(ENDER_PEARL, i * 4 / 5)))(bcLoaded, UnitMJ)
        addRecipe(ItemDamage(itemTool, 0), 80000, Seq(i => new ItemStack(GOLD_INGOT, i * 8), i => new ItemStack(IRON_INGOT, i * 12), i => new ItemStack(OBSIDIAN, i * 2), i => new ItemStack(DIAMOND, i * 2), i => new ItemStack(REDSTONE, i * 16), i => new ItemStack(DYE, i * 4, 4), i => new ItemStack(ENDER_PEARL, i * 3 / 25)))
        addRecipe(ItemDamage(ItemTool.getEditorStack), 160000, Seq(i => new ItemStack(IRON_INGOT, i * 8), i => new ItemStack(BOOK, i * 32), i => new ItemStack(FEATHER, i * 1), i => new ItemStack(DYE, i * 8), i => new ItemStack(DIAMOND, i * 2), i => new ItemStack(REDSTONE, i * 2), i => new ItemStack(ENDER_PEARL, i * 1 / 5)))
        addRecipe(ItemDamage(itemTool, 2), 320000, Seq(i => new ItemStack(IRON_INGOT, i * 32), i => new ItemStack(LAVA_BUCKET, i * 6 / 5), i => new ItemStack(WATER_BUCKET, i * 6 / 5), i => new ItemStack(ENDER_PEARL, i * 3 / 25)))
        addRecipe(ItemDamage(blockBreaker), 320000, Seq(i => new ItemStack(REDSTONE, i * 32), i => new ItemStack(DIAMOND, i * 12), i => new ItemStack(GOLD_INGOT, i * 16), i => new ItemStack(IRON_INGOT, i * 32), i => new ItemStack(ENDER_PEARL, i * 1)))
        addRecipe(ItemDamage(blockPlacer), 320000, Seq(i => new ItemStack(REDSTONE, i * 32), i => new ItemStack(DIAMOND, i * 12), i => new ItemStack(GOLD_INGOT, i * 32), i => new ItemStack(IRON_INGOT, i * 16), i => new ItemStack(ENDER_PEARL, i * 1)))
        addRecipe(ItemDamage(blockLaser), 640000, Seq(i => new ItemStack(DIAMOND, i * 8), i => new ItemStack(REDSTONE, i * 96), i => new ItemStack(OBSIDIAN, i * 16), i => new ItemStack(GLASS, i * 72), i => new ItemStack(GLOWSTONE_DUST, i * 32), i => new ItemStack(GOLD_INGOT, i * 16), i => new ItemStack(ENDER_PEARL, i * 1 / 5)))(bcLoaded, UnitMJ)
        ...
        addRecipe(ItemDamage(blockStandalonePump), 3200000, Seq(i => new ItemStack(blockPump, i * 1), i => new ItemStack(blockMiningWell, i * 1), i => new ItemStack(blockMarker, i * 3 / 2)))
    }
}
