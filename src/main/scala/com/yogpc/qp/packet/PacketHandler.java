...
public class PacketHandler {
    ...
    public static void init() {
        ...
        INSTANCE.registerMessage(id++, BlockListRequestMessage.class, IMessage::writeToBuffer, IMessage.decode(BlockListRequestMessage::new), IMessage::onReceiveInternal);
        INSTANCE.registerMessage(id++, DiffMessage.class, IMessage::writeToBuffer, IMessage.decode(DiffMessage::new), IMessage::onReceiveInternal);
        INSTANCE.registerMessage(id++, EnchantmentMessage.class, IMessage::writeToBuffer, IMessage.decode(EnchantmentMessage::new), IMessage::onReceiveInternal);
...
//        INSTANCE.registerMessage(id++, AdvContentMessage.class, IMessage::writeToBuffer, IMessage.decode(AdvContentMessage::new), IMessage::onReceiveInternal);
        ...
        INSTANCE.registerMessage(id++, RecipeSyncMessage.class, IMessage::writeToBuffer, IMessage.decode(RecipeSyncMessage::new), IMessage::onReceiveInternal);
