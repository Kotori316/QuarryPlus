...
//        INSTANCE.registerMessage(id++, AdvFilterMessage.class, AdvFilterMessage::writeToBuffer, IMessage.decode(AdvFilterMessage::new), AdvFilterMessage::onReceiveInternal);
//        INSTANCE.registerMessage(id++, AdvContentMessage.class, AdvContentMessage::writeToBuffer, IMessage.decode(AdvContentMessage::new), AdvContentMessage::onReceiveInternal);
