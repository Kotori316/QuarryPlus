...
public class Box {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof Box)) {
            ...
            Box var4 = (Box) obj;
            var2 = this.startX == var4.startX && this.startY == var4.startY && this.startZ == var4.startZ && this.endX == var4.endX && this.endY == var4.endY && this.endZ == var4.endZ && this.sizeX == var4.sizeX && this.sizeY == var4.sizeY && this.sizeZ == var4.sizeZ && this.firstSide == var4.firstSide && this.endSide == var4.endSide;
        }
    ...
    public Box(final double startX, final double startY, final double startZ, final double endX, final double endY, final double endZ, final double sizeX, final double sizeY, final double sizeZ, final boolean firstSide, final boolean endSide) {
        this.startX = startX;
        this.startY = startY;
        this.startZ = startZ;
        this.endX = endX;
    ...
    public static Box apply(final AxisAlignedBB axisAlignedBB, final double sizeX, final double sizeY, final double sizeZ, final boolean firstSide, final boolean endSide) {
    ...
    public static Box apply(final double startX, final double startY, final double startZ, final double endX, final double endY, final double endZ, final double sizeX, final double sizeY, final double sizeZ, final boolean firstSide, final boolean endSide) {
