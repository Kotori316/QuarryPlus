...
object WorkbenchRecipes {
    ...
    */
    ...
    def registerRecipes(): Unit = {
        ...
        addRecipe(ItemDamage(blockRefinery), 640000, new ItemStack(DIAMOND, 900), new ItemStack(GOLD_INGOT, 600), new ItemStack(IRON_INGOT, 600), new ItemStack(GLASS, 3200), new ItemStack(REDSTONE, 800), new ItemStack(ANVIL, 50), new ItemStack(OBSIDIAN, 600), new ItemStack(NETHER_STAR, 1), new ItemStack(ENDER_PEARL, 20))
        ...
        addRecipe(ItemDamage(itemTool, 1), 160000, new ItemStack(IRON_INGOT, 400), new ItemStack(BOOK, 1600), new ItemStack(FEATHER, 50), new ItemStack(DYE, 400), new ItemStack(DIAMOND, 100), new ItemStack(REDSTONE, 100), new ItemStack(ENDER_PEARL, 3))
