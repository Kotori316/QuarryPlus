...
final class RecipeGenerator extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput exporter) {
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_FLEX_MARKER)
            .pattern("glg")
            .pattern("lrl")
            .pattern("gl ")
            .define('r', Items.REDSTONE_TORCH)
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_ADV_PUMP)
            .pattern("bdb")
            .pattern("mqm")
            .pattern("gdg")
            ...
            .define('m', QuarryPlus.ModObjects.TAG_MARKERS)
            .unlockedBy("has_quarry", has(QuarryPlus.ModObjects.TAG_MARKERS))
        );
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_ADV_QUARRY)
            .pattern("mem")
            .pattern("gqg")
            .pattern("mem")
            .define('g', ConventionalItemTags.GREEN_DYES)
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_PLACER)
            .pattern("GDG")
            .pattern("MRM")
            .pattern("MIM")
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_REMOTE_PLACER)
            .pattern("eie")
            .pattern("dpd")
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_FILLER)
            .pattern("iii")
            .pattern("ala")
            .pattern("iii")
            .define('i', ConventionalItemTags.IRON_INGOTS)
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.ITEM_BEDROCK_MODULE)
            .pattern("ooo")
            .pattern(" m ")
            .pattern(" m ")
            .define('m', QuarryPlus.ModObjects.TAG_MARKERS)
            .define('o', Items.OBSIDIAN)
            .unlockedBy("has_marker", has(QuarryPlus.ModObjects.TAG_MARKERS))
        );
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.ITEM_CHECKER)
            .pattern("ggg")
            .pattern("lrl")
            .define('r', QuarryPlus.ModObjects.TAG_MARKERS)
            .define('g', ConventionalItemTags.GLASS_BLOCKS)
            .define('l', ConventionalItemTags.IRON_INGOTS)
            .unlockedBy("has_marker", has(QuarryPlus.ModObjects.TAG_MARKERS))
        );
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.ITEM_Y_SETTER)
            .pattern("ggg")
            .pattern("lrl")
            .define('r', QuarryPlus.ModObjects.TAG_MARKERS)
            .define('g', ConventionalItemTags.GLASS_BLOCKS)
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_WATERLOGGED_MARKER)
            .pattern("G")
            .pattern("M")
            .define('G', ConventionalItemTags.GREEN_DYES)
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_WATERLOGGED_FLEX_MARKER)
            .pattern("G")
            .pattern("M")
            .define('G', ConventionalItemTags.GREEN_DYES)
            .define('M', QuarryPlus.ModObjects.BLOCK_FLEX_MARKER)
        ...
        builders.add(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, QuarryPlus.ModObjects.BLOCK_WATERLOGGED_16_MARKER)
            .pattern("G")
            .pattern("M")
            .define('G', ConventionalItemTags.GREEN_DYES)
            .define('M', QuarryPlus.ModObjects.BLOCK_16_MARKER)
